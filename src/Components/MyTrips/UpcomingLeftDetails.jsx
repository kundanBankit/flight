...
export default function UpcomingLeftSidebar({ flight }) {
...
<div className="text-muted small">
  {flight.arrivalDate} • {flight.arrivalTime}
      ...
      <div className="card shadow-sm mb-4" style={{ borderRadius: "12px", overflow: "hidden" }}>
        <div className="p-3 fw-bold">MANAGE YOUR BOOKING</div>

        <div className="list-group list-group-flush">

          <Link
            to="/my-trips/upcoming/cancellation"
            state={{ flight }}
            className="list-group-item list-group-item-action d-flex justify-content-between"
          >
            <div>
              Cancellation
              <div className="small text-muted">Charges may apply</div>
            </div>
            ➜
          </Link>

          <Link
            to="/my-trips/upcoming/change-date"
            state={{ flight }}
            className="list-group-item list-group-item-action d-flex justify-content-between"
          >
            <div>
              Change travel date(s)
              <div className="small text-muted">Charges & fare difference may apply</div>
            </div>
            ➜
          </Link>
